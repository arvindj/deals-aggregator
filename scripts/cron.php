...
*/
    ...
    define('CRON_CI_INDEX', '/var/www/app/index.php');   // Your CodeIgniter main index.php file
...
# Parse the command line
    ...
    foreach($argv as $arg)
    {
        $key_value_arr =  explode('=', $arg);        
        if(isset($key_value_arr[0])) $param = $key_value_arr[0];
        if(isset($key_value_arr[1])) $value = $key_value_arr[1];
        switch($param)
        {
            case '--run':
